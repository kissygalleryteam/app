...
- [第三版](http://kg.kissyui.com/app/1.3/guide/index.html)，基于`kissy`1.3
- Update 2013-12-10
- [Demo with SDK](../demo/sdk/demo.html)，[Source](https://github.com/jayli/app/tree/master/2.0.0/demo/sdk)
...
[参考页面](https://github.com/jayli/app/blob/master/2.0.0/demo/simple/mb.html)。页面正文都需要添加HTML代码：
...
JavaScript:
	...
	KISSY.use('kg/app/2.0.0/',function(S,AppFramework){
...
### view 里的上下文
	...
	KISSY.use('mobile/app/2.0.0/',function(S,AppFramework){
...
框架初始化代码：
	...
	KISSY.use('kg/app/2.0.0/',function(S,AppFramwork){
		var app = AppFramwork({
			// 参数列表
		});
	});
...
- How：[sdk-h5.js](http://a.tbcdn.cn/s/kissy/kg/app/2.0.0/demo/sdk/h5.js)，[sdk-h4.js](http://a.tbcdn.cn/s/kissy/kg/app/2.0.0/demo/sdk/h4.js)，（参考）
...
`sdk-h4`
	...
	http://a.tbcdn.cn/s/kissy/kg/app/2.0.0/demo/sdk/h4.js

`sdk-h5`

	http://a.tbcdn.cn/s/kissy/kg/app/2.0.0/demo/sdk/h5.js

用法：在单页面中需要引入`sdk-h4.js`，[参照代码](https://github.com/jayli/app/blob/master/2.0.0/demo/sdk/a.php)。在框架页首页中需要引入`sdk-h5.js`。[参照代码](https://github.com/jayli/app/blob/master/2.0.0/demo/sdk/mb.php)。
